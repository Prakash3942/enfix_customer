...
export interface ScheduleAssignedStaffProps {}
...
const ScheduleAssignedStaff: React.FC<ScheduleAssignedStaffProps> = () => {
...
export default ScheduleAssignedStaff;
